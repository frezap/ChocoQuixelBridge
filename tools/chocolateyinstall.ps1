...
$url        = 'https://d2shgxa8i058x8.cloudfront.net/bridge/win/Bridge.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'QuixelBridge*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
